...
```{r}
  ...
  knit_extent = function(element_id){
    if(any(c(input_list[[paste0(element_id, "_xmin")]], input_list[[paste0(element_id, "_xmax")]], input_list[[paste0(element_id, "_ymin")]], input_list[[paste0(element_id, "_ymax")]])) == ""){
      knit_missing(element_id)
    } else {
...
for(i in 1:nrow(odmap_dict_rmd)){
  ...
  if(subsection_new != subsection & !(subsection_new %in% elem_hide[[input_list$o_objective_1]])){
