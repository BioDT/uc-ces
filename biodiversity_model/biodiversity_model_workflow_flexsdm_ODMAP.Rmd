...
download_path = paste0("GBIF_data_scotland_", params$species_folder_name)
...
if(!dir.exists(file.path("results", params$species_folder_name))){
  dir.create(file.path("results", params$species_folder_name))
}

output_raster_path = file.path("results", params$species_folder_name, params$out_file)
